...
--             へ  ♡
--         ૮ >  <)
--         / ⁻ ៸|         General style, look and feel configurations
--      乀(ˍ,ل ل
--
-- ---------------------------------------------------------------------------------
--
...
hl.config({
    general = {
        ...
        col = {
            -- TODO: gradient format unclear in Lua API — using single color as fallback
            active_border   = "rgba(F1B4CDaa)",
    ...
    -- Note: pseudotile was removed in Hyprland 0.55
    dwindle = {
        preserve_split = true
    },
